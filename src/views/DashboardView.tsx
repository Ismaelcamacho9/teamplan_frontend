...
export default function DashboardView() {
  ...
  if (data && user) return (
    <>
      ...
      <nav className="my-5 ">
        <Link
          className=" bg-green-light hover:bg-green-dark border-2  px-10 py-3 text-white  text-xl font-bold cursor-pointer transition-colors"
          to='/projects/create'
        >Nuevo Proyecto</Link>
      </nav>
      ...
      {data.length ? (
        ...
        <p className="text-center py-20">No hay proyectos aún {''}
          <Link
            to='/projects/create'
            className=" text-green-dark hover:text-green-light font-bold"
          >Crear Proyecto</Link>
        </p>
      )}
