        ...
        <div className='mb-10'>
            <div className="sm:hidden">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full rounded-md border-gray-300 focus:border-green-light focus:ring-green-light"
                    ...
                    <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                        {tabs.map((tab) => (
                            ...
                            >
                                <tab.icon
                                    className={classNames(
                                        location.pathname === tab.href ? 'text-green-light' : 'text-gray-400 group-hover:text-gray-500',
                                        '-ml-0.5 mr-2 h-5 w-5'
                                    )}
                                    aria-hidden="true"
                                />
